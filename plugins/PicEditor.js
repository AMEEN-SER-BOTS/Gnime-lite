...
Module_Exports({ kingcmd: "ad", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
...
//=============================================================================
Module_Exports({ kingcmd: "jail", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
...
//=============================================================================
Module_Exports({ kingcmd: "uncover", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "clown", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "mnm", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "pett", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "greyscale", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "invert", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "blur", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//============================================================================
Module_Exports({ kingcmd: "drip", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "colorify", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "gun", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "wanted", kingclass: "media editor", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
