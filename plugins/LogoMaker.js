...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "glow", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//----------------------------------------------------------------------------------- 
Module_Exports({ kingcmd: "glittch", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//---------------------------------------------------------------------------
//================================================================================================================================
Module_Exports({ kingcmd: "stel",alias:['steal'],kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "avenger",kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "marvel",kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "phub",kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "glitch3",kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "glitch2",kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "grafiti",kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//================================================================================================================================
    //---------------------------------------------------------------------------
    Module_Exports({ kingcmd: "deepsea", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "horror", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "whitebear", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "joker", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "metallic", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "steel", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "harrypotter", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "underwater", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "luxury", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "glue", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "fabric", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "toxic", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "ancient", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "cloud", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "transformer", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "thunder", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "scifi", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({kingcmd: "sand", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "rainbow", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "pencil", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "neon2", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({kingcmd: "magma", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "leaves", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "glitch", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
            if (!text) return citel.reply(`*_Example: ${prefix}glitch Zubair_*`)
            return await singleText(Void, citel , 'create-impressive-glitch-text-effects-online-1027' , text )
        })
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "discovery", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "christmas", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "candy", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "1917", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "blackpink", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-------------------------------------------------------------------------------
Module_Exports({ kingcmd: "neon", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-------------------------------------------------------------------------------
Module_Exports({ kingcmd: "summer", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-------------------------------------------------------------------------------
Module_Exports({ kingcmd: "pixel", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "2024", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "newyear", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "party", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "valentine", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "frozen", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "golden",kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "glass", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "deluxe", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "captain",kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "black", kingclass: "text pro", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
