...
async(sigma, citel, text) => {
    ...
    try {
        ...
        await sigma.sendMessage(citel.chat, { video: { url: media ,}, caption: `*ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ ${name.botname}*`  },)
...
return citel.reply(a,{packname:'GNIME',author:'ZUBI'},"sticker") 
