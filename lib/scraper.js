...
if (fs.existsSync('./menus/' + Config.LANG + '.json')) {	
	//log(pint('Loading ' + Config.LANG + ' language...', '.'));	
	var json = JSON.parse(fs.readFileSync('./menus/' + Config.LANG + '.json'));	
} else {	
	var json = JSON.parse(fs.readFileSync('./menus/GNIME.json'));	
}	
